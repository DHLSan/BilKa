...
entity load_bigendian_BUS_A_s_axi is
generic (
...
end entity load_bigendian_BUS_A_s_axi;
...
architecture behave of load_bigendian_BUS_A_s_axi is
    ...
    signal int_x               : UNSIGNED(7 downto 0) := (others => '0');
    signal int_y               : UNSIGNED(7 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_X_DATA_0 =>
                        rdata_data <= RESIZE(int_x(7 downto 0), 32);
                    when ADDR_Y_DATA_0 =>
                        rdata_data <= RESIZE(int_y(7 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_X_DATA_0) then
                    int_x(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_x(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_Y_DATA_0) then
                    int_y(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_y(7 downto 0));
                end if;
            end if;
        end if;
    end process;
